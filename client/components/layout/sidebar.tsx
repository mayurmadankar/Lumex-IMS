...
const pathTitleOverrides: Record<string, string> = {
  ...
  "/user/transfer/available-stock": "Available Company Stock",
  "/user/transfer/transfer-requests": "Transfer Requests",
  "/user/transfer/incoming-requests": "Incoming Requests",
  "/user/transfer/my-requests": "My Requests",
  "/user/transfer/notifications": "Notifications",
